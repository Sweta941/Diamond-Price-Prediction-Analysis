...
2. **Open the notebook**
```
Diamond_Price_Data_Regression.ipynb
```

3. **Run all cells** (Shift + Enter or use "Run All" from Cell menu)
...
new_diamond = pd.DataFrame({
    'carat': [1.5],
    'cut': [4],  # Premium (encoded: 1-5)
    'color': [6],  # G (encoded: 1-7)
    'clarity': [7],  # VS1 (encoded: 1-8)
    'depth': [62.5],
    'table': [55.0]
})
